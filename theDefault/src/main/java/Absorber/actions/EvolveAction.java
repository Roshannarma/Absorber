...
public class EvolveAction extends AbstractGameAction {
    private boolean retrieveCard = false;
    private final ArrayList<AbstractCard> generatedCards;

    public EvolveAction(ArrayList<AbstractCard> inputcards){
        this.actionType = ActionType.CARD_MANIPULATION;
        this.duration = Settings.ACTION_DUR_FAST;
        generatedCards = inputcards;
        this.amount = 1;
    }
        ...
        if (this.duration == Settings.ACTION_DUR_FAST) {
            ...
            if (!this.retrieveCard) {
                if (AbstractDungeon.cardRewardScreen.discoveryCard != null) {
                    ...
                    AbstractCard c = new LivingDagger();
                    c.rawDescription += "new text";
