...
public class EntangleThemPower extends AbstractPower implements CloneablePowerInterface {
    public AbstractCreature source;

    public static final String POWER_ID = DefaultMod.makeID("EntangleThem");
...
//    }
    ...
    public void atEndOfRound() {
        flash();
        addToBot((AbstractGameAction) new RemoveSpecificPowerAction(this.owner, this.owner, "Absorber:EntangleThem"));
    }
