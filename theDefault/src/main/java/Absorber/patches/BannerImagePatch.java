...
@SpirePatch(    // "Use the @SpirePatch annotation on the patch class."
        ...
        method = "renderBannerImage"// This is the name of the method we will be patching.
        /*
...
public class BannerImagePatch {// Don't worry about the "never used" warning - *You* usually don't use/call them anywhere. Mod The Spire does.
    ...
    private static final Texture MONSTER_BANNER = new Texture("AbsorberResources/images/Rarity/Banner1.png");
...
//    )
    ...
    @SpirePrefixPatch
    public static SpireReturn FunctiontoAppend(AbstractCard __instance, SpriteBatch sb, float drawX, float drawY
