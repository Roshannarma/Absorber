...
@SpirePatch(    // "Use the @SpirePatch annotation on the patch class."
        ...
        method = "renderPowerPortrait"// This is the name of the method we will be patching.
        /*
...
public class MonsterPowerPatch {// Don't worry about the "never used" warning - *You* usually don't use/call them anywhere. Mod The Spire does.
    ...
    private static final Logger logger = LogManager.getLogger(BannerImagePatch.class.getName()); // This is our logger! It prints stuff out in the console.
    private static final Texture MONSTER_BANNER = new Texture("AbsorberResources/images/Rarity/Power1.png");
