...
@SpirePatch(    // "Use the @SpirePatch annotation on the patch class."
        clz = NeowReward.class, // This is the class where the method we will be patching is. In our case - Abstract Dungeon
        method = "getRewardOptions" // This is the name of the method we will be patching.
        /*
...
public class LinkedSoulsStringPatch {// Don't worry about the "never used" warning - *You* usually don't use/call them anywhere. Mod The Spire does.
    ...
    public static SpireReturn<ArrayList<NeowReward.NeowRewardDef>> thisIsOurActualPatchMethod(ArrayList<NeowReward.NeowRewardDef>  rewardOptions
...
//        logger.info(category);
        if(AbstractDungeon.player instanceof TheDefault){
            rewardOptions.add(new NeowReward.NeowRewardDef(NeowReward.NeowRewardType.BOSS_RELIC, description));
