...
@SpirePatch(    // "Use the @SpirePatch annotation on the patch class."
        ...
        method = "renderSkillPortrait"// This is the name of the method we will be patching.
        /*
...
public class MonsterSkillPatch {// Don't worry about the "never used" warning - *You* usually don't use/call them anywhere. Mod The Spire does.
    ...
    private static final Texture MONSTER_BANNER = new Texture("AbsorberResources/images/Rarity/Skill1.png");
