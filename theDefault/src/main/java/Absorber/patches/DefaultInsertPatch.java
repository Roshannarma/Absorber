...
@SpirePatch(    // "Use the @SpirePatch annotation on the patch class."
        ...
        method = "calculateCardDamage" // This is the name of the method we will be patching.
        /*
...
public class DefaultInsertPatch {// Don't worry about the "never used" warning - *You* usually don't use/call them anywhere. Mod The Spire does.
    ...
    public static void thisIsOurActualPatchMethod(AbstractCard __instance, AbstractMonster mo
...
//            logger.info(1);
            DefaultMod.temporary = AddCardFromConsume.displaycard(mo,true);
//            logger.info("2");
