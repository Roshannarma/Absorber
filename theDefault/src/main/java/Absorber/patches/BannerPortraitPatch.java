...
@SpirePatch(    // "Use the @SpirePatch annotation on the patch class."
        ...
        method = "renderCardBanner"// This is the name of the method we will be patching.
        /*
...
public class BannerPortraitPatch {// Don't worry about the "never used" warning - *You* usually don't use/call them anywhere. Mod The Spire does.
    ...
    private static final Logger logger = LogManager.getLogger(BannerPortraitPatch.class.getName());
    private static final Texture MONSTER_BANNER = new Texture("AbsorberResources/images/Rarity/Banner_p.png");
...
//    )
    ...
    @SpireInsertPatch(rloc = 1, localvars = {"tmpImg"})
    public static SpireReturn FunctiontoAppend(SingleCardViewPopup __instance, SpriteBatch sb, @ByRef AbstractCard ___card[],@ByRef TextureAtlas.AtlasRegion tmpImg[]
