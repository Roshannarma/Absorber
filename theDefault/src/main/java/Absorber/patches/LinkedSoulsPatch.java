...
@SpirePatch(    // "Use the @SpirePatch annotation on the patch class."
        ...
        method = "activate" // This is the name of the method we will be patching.
        /*
...
public class LinkedSoulsPatch {// Don't worry about the "never used" warning - *You* usually don't use/call them anywhere. Mod The Spire does.
    ...
    public static SpireReturn thisIsOurActualPatchMethod(
