...
public class BloodTransfusion extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID("BloodTransfusion");
    public static final String IMG = makeFinalCardPath("BloodTransfusion");
    ...
    public void use(final AbstractPlayer p, final AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p,p,new StrengthPower(p,defaultSecondMagicNumber)));
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p,p,new LoseStrengthPower(p,defaultSecondMagicNumber)));
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p,p,new DexterityPower(p,defaultSecondMagicNumber)));
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p,p,new LoseDexterityPower(p,defaultSecondMagicNumber)));
        this.exhaust = true;
    }
