...
//@AutoAdd.Ignore
public class Hospitalize extends AbstractDynamicCard {


    public static final String ID = DefaultMod.makeID("Hospitalize");
    ...
    private static final int DAMAGE = 27;    // DAMAGE = ${DAMAGE}
