...
@AutoAdd.Ignore
public class Operation extends AbstractDynamicCard {


    public static final String ID = DefaultMod.makeID("Operation");
    ...
    public Operation() {
        ...
        baseMagicNumber = magicNumber = DRAW_VULNERABLE;
    }
