...
@AutoAdd.Ignore
public class ReptoDaggerP extends AbstractDynamicCard {


    public static final String ID = DefaultMod.makeID("ReptoDaggerP");
...
//    private static final int UPGRADE_PLUS_DMG = 5;  // UPGRADE_PLUS_DMG = ${UPGRADED_DAMAGE_INCREASE}
    ...
    private static final int MIRACLE = 1;
    private static final int UPGRADE_PLUS_MIRACLE = 1;
    public ReptoDaggerP() {
        super(ID, IMG, COST, TYPE, COLOR, RARITY, TARGET);
        baseDamage = damage = DAMAGE;
        baseMagicNumber = magicNumber = MIRACLE;
    }
    ...
    public void upgrade() {
        if (!upgraded) {
            upgradeName();
            upgradeMagicNumber(UPGRADE_PLUS_MIRACLE);
