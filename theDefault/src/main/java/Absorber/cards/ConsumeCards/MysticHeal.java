...
//@AutoAdd.Ignore
public class MysticHeal extends AbstractDynamicCard {


    // TEXT DECLARATION

    public static final String ID = DefaultMod.makeID("MysticHeal");
    public static final String IMG = makeFinalCardPath("Mystic");
    ...
    private static final int UPGRADE_PLUS_HEAL_AMOUNT = 3;

    // /STAT DECLARATION/

    public MysticHeal() {
        super(ID, IMG, COST, TYPE, COLOR, RARITY, TARGET);
        baseMagicNumber = magicNumber = HEAL_AMOUNT;
