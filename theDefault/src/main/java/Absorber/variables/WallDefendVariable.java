...
public class WallDefendVariable extends DynamicVariable
{   // Custom Dynamic Variables are what you do if you need your card text to display a cool, changing number that the base game doesn't provide.
    ...
    {
        return card.isBlockModified || (WallDefendAction.returnTotal()>0);
    }
    ...
    {
        return card.block + WallDefendAction.returnTotal();
    }
