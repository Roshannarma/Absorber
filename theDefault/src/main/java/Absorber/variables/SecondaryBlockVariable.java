...
import Absorber.cards.Normal.EnergyWall;
import Absorber.cards.Normal.StimAOE;
...
{   // Custom Dynamic Variables are what you do if you need your card text to display a cool, changing number that the base game doesn't provide.
    ...
    {
        return ( (EnergyWall) card).isSecondaryModified;
    }
    ...
    {
        return ( (EnergyWall) card).secondary_block;
    }
    ...
    {
        return ( (EnergyWall) card).base_secondary_block;
    }
    ...
    {
        return ( (EnergyWall) card).isSecondaryUpgraded;
    }
}
