...
import Absorber.cards.*;
import Absorber.characters.TheDefault;
import Absorber.events.IdentityCrisisEvent;
import Absorber.potions.PlaceholderPotion;
import Absorber.util.IDCheckDontTouchPls;
...
public class DefaultMod implements
    ...
    private static final String THE_DEFAULT_PORTRAIT = "AbsorberResources/images/charSelect/CharacterSelect1.png";
    public static final String THE_DEFAULT_SHOULDER_1 = "AbsorberResources/images/char/defaultCharacter/shoulder.png";
    public static final String THE_DEFAULT_SHOULDER_2 = "AbsorberResources/images/char/defaultCharacter/shoulder2.png";
    public static final String THE_DEFAULT_CORPSE = "AbsorberResources/images/char/defaultCharacter/corpse.png";
    
    //Mod Badge - A small icon that appears in the mod settings menu next to your mod.
    public static final String BADGE_IMAGE = "AbsorberResources/images/Badge.png";
    ...
    public static String makeFinalCardPath(String resourcePath){
        return getModID() + "Resources/images/cards/" + resourcePath +"/"+ resourcePath + ".png";
    }
...
//        BaseMod.addRelicToCustomPool(new DefaultClickableRelic(), TheDefault.Enums.COLOR_GRAY);
    ...
    public void receiveEditCards() {
        ...
        new AutoAdd("Absorber") // ${project.artifactId}
        ...
        AddCardFromConsume temp = new AddCardFromConsume();
    ...
    public void receiveEditStrings() {
        ...
        BaseMod.loadCustomStringsFile(CardStrings.class,
                getModID() + "Resources/localization/eng/Absorber-Card-Strings.json");
        
        // PowerStrings
        BaseMod.loadCustomStringsFile(PowerStrings.class,
                getModID() + "Resources/localization/eng/Absorber-Power-Strings.json");
        ...
        BaseMod.loadCustomStringsFile(PotionStrings.class,
                getModID() + "Resources/localization/eng/Absorber-Potion-Strings.json");
        
        // CharacterStrings
        BaseMod.loadCustomStringsFile(CharacterStrings.class,
                getModID() + "Resources/localization/eng/Absorber-Character-Strings.json");
        
        // OrbStrings
        BaseMod.loadCustomStringsFile(OrbStrings.class,
                getModID() + "Resources/localization/eng/Absorber-Orb-Strings.json");
    ...
    public void receiveEditKeywords() {
        ...
        Gson gson = new Gson();
        String json = Gdx.files.internal(getModID() + "Resources/localization/eng/Absorber-Keyword-Strings.json").readString(String.valueOf(StandardCharsets.UTF_8));
